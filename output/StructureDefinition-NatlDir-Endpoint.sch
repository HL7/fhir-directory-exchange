...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Endpoint">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/national-healthcare-directory/StructureDefinition/secureEndpoint']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/national-healthcare-directory/StructureDefinition/secureEndpoint': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Endpoint/f:meta</sch:title>
