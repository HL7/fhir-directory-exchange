...
* rest[0].mode = #server
* rest.documentation =  "http://www.w3.org/1999/xhtml\"><h2 id=\"title\">Capability Statement Basic Federated Endpoint Server  </h2><ul><li><b>Official URL:</b><code>http://hl7.org/fhir/us/fhir-directory-query/CapabilityStatement/fhir-directory-query-basic-endpoint</code></li><li><b>Implementation Guide Version:</b> 0.0.1</li><li><b>FHIR Version:</b> 4.0.1</li><li><b>Intended Use:</b> Requirements</li><li><b>Supported Formats:</b>\n\t\t\t\t\n                    XML, JSON\n\t\t\t\t\n\t\t\t\t</li><li><b>Published:</b> 2022-02-15 07:15:00.000000-04:00</li><li><b>Published by:</b> HL7 Patient Administration Working Group</li><li><b>Status:</b> Draft (experimental)</li></ul><p>Capabilities for a basic Query Server for Health Services where endpoint search capabilities are met</p><!-- No support expectation extension --><h3 class=\"no_toc\" id=\"igs\">Support the Following Implementation Guides:</h3><ul><li><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/\">https://build.fhir.org/ig/HL7/fhir-directory-exchange/</a></li></ul><!-- REST Behavior --><h3 id=\"behavior\">FHIR Server RESTful Capabilities</h3><p>A Federated Query server <strong>SHALL</strong>:</p><ol><li>Support all profiles defined in this Implementation Guide..</li><li>Implement the RESTful behavior according to the FHIR specification.</li><li>Return the following response classes:\n<ul><li>(Status 400): invalid parameter</li><li>(Status 401/4xx): unauthorized request</li><li>(Status 403): insufficient scope</li><li>(Status 404): unknown resource</li><li>(Status 410): deleted resource.</li></ul>\n</li><li>Support json source formats for all mCODE interactions.</li><li>Identify the mCODE  profiles supported as part of the FHIR <code>meta.profile</code> attribute for each instance.</li><li>Support the searchParameters on each profile individually and in combination.</li></ol><p>The Federated Query Server <strong>SHOULD</strong>:</p><ol><li>Support xml source formats for all mCODE interactions.</li></ol><p id=\"security\"><strong>Security:</strong></p><ol><li>See the <a href=\"https://www.hl7.org/fhir/security.html#general\">General Security Considerations</a> section for requirements and recommendations.</li><li>A client <strong>SHALL</strong> reject any unauthorized requests by returning an <code>HTTP 401</code> unauthorized response code.</li></ol><h3 class=\"no_toc\" id=\"resource--details\">RESTful Capabilities by Resource/Profile:</h3><p><strong>Summary</strong></p><table class=\"grid\"><thead><tr><th>Resource Type</th><th>Supported Interactions</th><th>Supported Profiles</th><th>Supported Searches</th><th>Supported <code>_includes</code></th><th>Supported <code>_revincludes</code></th><th>Supported Operations</th></tr></thead><tbody><tr><td><a href=\"#endpoint\">endpoint</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Endpoint.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Endpoint.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tidentifier, usecase-type\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#healthcareservice\">healthcareService</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-HealthcareService.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-HealthcareService.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tservice-category, coverage-area, endpoint, location, name, organization, specialty, service-type\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#insuranceplan\">InsurancePlan</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-InsurancePlan.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-InsurancePlan.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tcoverage-area, administrated-by, coverage-benefit-type, coverage-network, identifier, type, name, owned-by\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#location\">location</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-location.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-location.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\taddress, endpoint, organization, physicalType, partOf, type\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#network\">network</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-network.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-network.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tcoverage-area, name\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#organization\">organization</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-organization.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-organization.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\ttype, address, endpoint, identifier, name, partOf\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#organizationaffiliation\">OrganizationAffiliation</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-OrganizationAffiliation.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-OrganizationAffiliation.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tendpoint, location, network, participating-organization, primary-organization, role, service, specialty\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#practitioner\">Practitioner</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Practitioner.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Practitioner.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tname, family, given, identifier, identifier-assigner, qualification-code, qualification-issuer\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#practitionerrole\">PractitionerRole</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-PractitionerRole.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-PractitionerRole.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tendpoint, location, network, organization, Practicioner, role, service, specialty\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#restriction\">Restriction</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Restriction.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Restriction.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\t_id, _id, _lastUpdated, plan-type, name, coverage-area, owned=by, administrated-by\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#validation\">Validation</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Validation.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Validation.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tattestation-who, primarysource-who, target\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr><tr><td><a href=\"#careteam\">CareTeam</a></td><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Profiles --><td><a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-CareTeam.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-CareTeam.html)</a></td><!-- Supported Searches --><td>\n\t\t\t\t\t\t\t\t\t\tendpoint, location, name, organization, service, category\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _includes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported _revincludes --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td><!-- Supported Operations --><td>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t</td></tr></tbody></table><!-- Resource Details --><h4 class=\"no_toc\" id=\"endpoint\">endpoint</h4><p>Conformance Expectation:\t<strong>SHALL</strong></p><p>Supported Profiles:</p><ul><li><strong>SHALL</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Endpoint.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Endpoint.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"healthcareservice\">healthcareService</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>MAY</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-HealthcareService.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-HealthcareService.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"insuranceplan\">InsurancePlan</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>MAY</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-InsurancePlan.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-InsurancePlan.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"location\">location</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>SHOULD</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-location.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-location.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"network\">network</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>MAY</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-network.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-network.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"organization\">organization</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>SHALL</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-organization.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-organization.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"organizationaffiliation\">OrganizationAffiliation</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>MAY</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-OrganizationAffiliation.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-OrganizationAffiliation.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"practitioner\">Practitioner</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>SHOULD</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Practitioner.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Practitioner.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"practitionerrole\">PractitionerRole</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>SHOULD</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-PractitionerRole.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-PractitionerRole.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"restriction\">Restriction</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>MAY</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Restriction.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Restriction.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"validation\">Validation</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>MAY</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Validation.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-Validation.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul><h4 class=\"no_toc\" id=\"careteam\">CareTeam</h4><p>Conformance Expectation:\t<strong>(conformance expectation undefined)</strong></p><p>Supported Profiles:</p><ul><li><strong>MAY</strong> support:\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-CareTeam.html\">(https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-CareTeam.html)</a>\n\t\t\t\t\t\t\t\t\t\t</li></ul></div>"
...
* rest[0].resource[0].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-EndpointComplete.html"
...
* rest[0].resource[0].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-EndpointComplete-identifier"
...
* rest[0].resource[0].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-EndpointComplete-connection-type.html"
...
* rest[0].resource[0].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-EndpointComplete-mime-type.html"
...
* rest[0].resource[0].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-EndpointComplete-organization.html"
...
* rest[0].resource[0].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-EndpointComplete-payload-type.html"
...
* rest[0].resource[0].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-EndpointComplete-usecase-standard.html"
...
* rest[0].resource[0].searchParam[6].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-EndpointComplete-status.html"
...
* rest[0].resource[0].searchParam[7].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-EndpointComplete-usecase-type.html"
...
* rest[0].resource[10].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-CareTeamComplete.html"
...
* rest[0].resource[10].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-CareTeamComplete-Endpoint"
...
* rest[0].resource[10].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-CareTeamComplete-location"
...
* rest[0].resource[10].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-CareTeamComplete-name"
...
* rest[0].resource[10].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-CareTeamComplete-organization"
...
* rest[0].resource[10].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-CareTeamComplete-service"
...
* rest[0].resource[10].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-CareTeamComplete-category"
...
* rest[0].resource[1].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-HealthcareServiceComplete.html"
...
* rest[0].resource[1].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-HealthcareServiceComplete-service-category"
...
* rest[0].resource[1].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-HealthcareServiceComplete-coverage-area"
...
* rest[0].resource[1].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-HealthcareServiceComplete-EndpointComplete"
...
* rest[0].resource[1].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-HealthcareServiceComplete-location"
...
* rest[0].resource[1].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-HealthcareServiceComplete-name"
...
* rest[0].resource[1].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-HealthcareServiceComplete-organization"
...
* rest[0].resource[1].searchParam[6].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-HealthcareServiceComplete-specialty"
...
* rest[0].resource[1].searchParam[7].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-HealthcareServiceComplete-service-type"
...
* rest[0].resource[3].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-locationComplete.html"
...
* rest[0].resource[3].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-locationComplete-address"
...
* rest[0].resource[3].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-locationComplete-EndpointComplete"
...
* rest[0].resource[3].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-locationComplete-organization"
...
* rest[0].resource[3].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-locationComplete-physicalType"
...
* rest[0].resource[3].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-locationComplete-partOf"
...
* rest[0].resource[3].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-locationComplete-type"
...
* rest[0].resource[4].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-organizationComplete.html"
* rest[0].resource[4].supportedProfile[1] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-networkComplete.html"
...
* rest[0].resource[4].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationComplete-type"
...
* rest[0].resource[4].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationComplete-address"
...
* rest[0].resource[4].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationComplete-EndpointComplete"
...
* rest[0].resource[4].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationComplete-identifier"
...
* rest[0].resource[4].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationComplete-name"
...
* rest[0].resource[4].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationComplete-partOf"
...
* rest[0].resource[4].searchParam[7].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-networkComplete-name"
...
* rest[0].resource[5].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-organizationAffiliationComplete.html"
...
* rest[0].resource[5].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationAffiliationComplete-EndpointComplete"
...
* rest[0].resource[5].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationAffiliationComplete-location"
...
* rest[0].resource[5].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationAffiliationComplete-network"
...
* rest[0].resource[5].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationAffiliationComplete-participating-organization"
...
* rest[0].resource[5].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationAffiliationComplete-primary-organization"
...
* rest[0].resource[5].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationAffiliationComplete-role"
...
* rest[0].resource[5].searchParam[6].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationAffiliationComplete-service"
...
* rest[0].resource[5].searchParam[7].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-organizationAffiliationComplete-specialty"
...
* rest[0].resource[6].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-PractitionerComplete.html"
...
* rest[0].resource[6].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerComplete-name"
...
* rest[0].resource[6].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerComplete-family"
...
* rest[0].resource[6].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerComplete-given"
...
* rest[0].resource[6].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerComplete-identifier"
...
* rest[0].resource[6].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerComplete-identifier-assigner"
...
* rest[0].resource[6].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerComplete-qualification-code"
...
* rest[0].resource[6].searchParam[6].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerComplete-qualification-issuer"
...
* rest[0].resource[7].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-PractitionerRoleComplete.html"
...
* rest[0].resource[7].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerRoleComplete-Endpoint"
...
* rest[0].resource[7].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerRoleComplete-location"
...
* rest[0].resource[7].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerRoleComplete-network"
...
* rest[0].resource[7].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerRoleComplete-organization"
...
* rest[0].resource[7].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerRoleComplete-Practicioner"
...
* rest[0].resource[7].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerRoleComplete-role"
...
* rest[0].resource[7].searchParam[6].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerRoleComplete-service"
...
* rest[0].resource[7].searchParam[7].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-PractitionerRoleComplete-specialty"
...
* rest[0].resource[2].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-InsurancePlanComplete.html"
...
* rest[0].resource[2].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-InsurancePlanComplete-coverage-area"
...
* rest[0].resource[2].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-InsurancePlanComplete-administrated-by"
...
* rest[0].resource[2].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-InsurancePlanComplete-coverage-benefit-type"
...
* rest[0].resource[2].searchParam[3].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-InsurancePlanComplete-coverage-network"
...
* rest[0].resource[2].searchParam[4].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-InsurancePlanComplete-identifier"
...
* rest[0].resource[2].searchParam[5].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-InsurancePlanComplete-type"
...
* rest[0].resource[2].searchParam[6].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-InsurancePlanComplete-name"
...
* rest[0].resource[2].searchParam[7].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-InsurancePlanComplete-owned-by"
...
* rest[0].resource[9].supportedProfile[0] = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/StructureDefinition-NatlDirEndpointQry-ValidationComplete.html"
...
* rest[0].resource[9].searchParam[0].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-ValidationComplete-attestation-who"
...
* rest[0].resource[9].searchParam[1].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-ValidationComplete-primarysource-who"
...
* rest[0].resource[9].searchParam[2].definition = "https://build.fhir.org/ig/HL7/fhir-directory-exchange/SearchParameter-ValidationComplete-target"
