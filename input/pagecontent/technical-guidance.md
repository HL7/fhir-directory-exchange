...
<figure class="figure">
<figcaption class="figure-caption"><strong>Figure 1: National Directory Concept Diagram</strong></figcaption>
...
The primary focus of this implementation guide is a RESTful API for obtaining data from a National Directory. The exchange API only supports a one-directional flow of information from a National Directory into local environments (i.e. HTTP GETs).

Any National Directory IG conformant implementation:
